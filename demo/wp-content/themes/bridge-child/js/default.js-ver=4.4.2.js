	...
	if($j('.more_facts_holder').length){
		$j('.more_facts_holder').each(function(){
			...
			$this.find('.more_facts_button').click(function(){
				var opending= $this.find('.more_facts_button');
				if ($j(".more_fact_opened")[0]){
					if (opending.parent().parent().find('.more_facts_outer').is(':visible')){
					...
					$j(this).find('.more_facts_button_arrow').removeClass('rotate_arrow');
						...
						$j(".more_fact_opened .more_facts_fake_arrow").fadeOut(speed);
					$j(".more_fact_opened .more_facts_outer").stop().animate({'height': '0px'}, 0.3,function(){
						$j(".more_fact_opened .more_facts_outer").css({'display':'none','opacity':'0'});
						$j(".more_fact_opened .more_facts_button_arrow").removeClass('rotate_arrow');
					    $j(".more_fact_opened").removeClass('more_fact_opened');
						
						opending.parent().parent().find('.more_facts_fake_arrow').fadeIn(speed);
						opending.parent().parent().addClass('more_fact_opened');
						opending.parent().parent().find('.more_facts_outer').css({'display':'block','opacity':'1'}).stop().animate({'height': height+5}, speed, function() {
						if($j('.parallax_section_holder').length) {
							initParallax();
						}
						...
						opending.parent().parent().find('.more_facts_button_text').text($less_label);
					opending.parent().parent().find('.more_facts_button_arrow').addClass('rotate_arrow');
					}
				...
				if(!$this.find('.more_facts_outer').is(':visible')){
					...
					$j(this).parent().parent().find('.more_facts_outer').css({'display':'block','opacity':'1'}).stop().animate({'height': height+5}, speed, function() {
						if($j('.parallax_section_holder').length) {
							initParallax();
						}
					});
		...
		$j('.search_slides_from_window_top').click(function(e){
			...
			if($j('html').hasClass('touch')){
				...
				if ($j('.qode_search_form').height() == "0") {
					...
					$j('.header_top_bottom_holder').stop().animate({top:"65px"},150);
					$j('.qode_search_form').stop().animate({height:"65px"},150);
					$j('.content_inner').stop().animate({marginTop:"65px"},150);
					if($scroll < 34){ $j('header.page_header').stop().animate({top:0},150); }
					$j('.title.has_fixed_background').animate({
						'background-position-y': (yPos + 65)+'px'
					}, 150);
				} else {
				...
				$j(window).scroll(function() {
					if ($j('.qode_search_form').height() != "0" && $scroll > 65) {
						$j('.qode_search_form').stop().animate({height:"0"},150);
						$j('.header_top_bottom_holder').stop().animate({top:"0px"},150);
						$j('.content_inner').stop().animate({marginTop:"0"},150);
